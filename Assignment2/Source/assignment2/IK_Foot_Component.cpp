...
UIK_Foot_Component::UIK_Foot_Component()
{
...
void UIK_Foot_Component::BeginPlay()
{
	Super::BeginPlay();
...
void UIK_Foot_Component::EndPlay(const EEndPlayReason::Type EndPlayReason)
{
...
// Called every frame
void UIK_Foot_Component::TickComponent(float DeltaTime, ELevelTick TickType, FActorComponentTickFunction* ThisTickFunction)
{
...
void UIK_Foot_Component::Set_IKSocketName(FString sSocName_LeftFoot, FString sSocName_RightFoot)
{
	m_sIKSocketName_LeftFoot = FName(*sSocName_LeftFoot);
	m_sIKSocketName_RightFoot = FName(*sSocName_RightFoot);
}

void UIK_Foot_Component::IK_ResetVars()
{
...
void UIK_Foot_Component::IK_Update(float fDeltaTime)
{
...
void UIK_Foot_Component::IK_Debug()
{
...
void UIK_Foot_Component::SetIKDebug(bool bActive)
{
	m_bDebug = bActive;
}


void UIK_Foot_Component::IK_Update_FootOffset(float fDeltaTime, float fTargetValue, float* fEffectorValue, float fInterpSpeed)
{
...
void UIK_Foot_Component::IK_Update_FootRotation(float fDeltaTime, FRotator pTargetValue, FRotator * pFootRotatorValue, float fInterpSpeed)
{
...
void UIK_Foot_Component::IK_Update_CapsuleHalfHeight(float fDeltaTime, float fHipsShifts, bool bResetDefault)
{
...
ST_IK_TraceInfo UIK_Foot_Component::IK_FootTrace(float fTraceDistance, FName sSocket)
{
...
bool UIK_Foot_Component::IsMoving()
{
...
void UIK_Foot_Component::SetIKActive(bool bActive)
{
	m_bActive = bActive;
}

FRotator UIK_Foot_Component::NormalToRotator(FVector pVector)
{
